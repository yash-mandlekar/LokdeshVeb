        ...
        <div className="editProfileRight">
          ...
          <div className="editProfileRightBox2">
            <div className="editProfileLeftBoxSingle">
              <Link to="/user/photoupload"><button class="button"><i class="bi bi-file-post"></i> Upload my post</button></Link>
              <button class="button"><i class="bi bi-save"></i> &nbsp;saved post</button>
            </div>
          </div>
        </div>
      </div>
